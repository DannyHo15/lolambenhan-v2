...
export default function YHCTPage() {
  const { formData, calculated, updateField, resetForm, getExportData, lastSaved, clearSaved, tomtatCombined, setTomtatUser } = useMedicalForm({ persistenceKey: "yhct" });
  ...
  const previewHtml = buildHTMLPreview(getExportData(), "BỆNH ÁN Y HỌC CỔ TRUYỀN");
