...
export default function GMHSSVPage() {
  const { formData, calculated, updateField, resetForm, getExportData, lastSaved, clearSaved, tomtatCombined, setTomtatUser } = useMedicalForm({ persistenceKey: "gmhs-sv" });
  ...
  const previewHtml = buildHTMLPreview(getExportData(), "BỆNH ÁN GÂY MÊ HỒI SỨC (SINH VIÊN)");
