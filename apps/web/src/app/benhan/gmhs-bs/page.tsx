...
export default function GMHSBSPage() {
  const {
    formData,
    calculated,
    updateField,
    ...
    tomtatCombined,
    setTomtatUser,
  } = useMedicalForm({ persistenceKey: "gmhs-bs" });
  const [showPreview, setShowPreview] = useState(false);

  const handleExport = async () => {
    const data = getExportData();
    clearSaved();
    await generateNoiKhoaDocx(data, `${data.hoten || "benhan-gmhs-bs"}.docx`);
  };
    ...
    <div className="min-h-screen bg-transparent pt-0 pb-8 px-4">
      ...
      <main className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          >
            Form BỆNH ÁN GÂY MÊ HỒI SỨC (BÁC SĨ)
          </h1>
