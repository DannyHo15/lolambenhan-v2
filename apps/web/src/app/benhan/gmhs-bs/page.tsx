...
export default function GMHSBSPage() {
  const { formData, calculated, updateField, resetForm, getExportData, lastSaved, clearSaved, tomtatCombined, setTomtatUser } = useMedicalForm({ persistenceKey: "gmhs-bs" });
  ...
  const previewHtml = buildHTMLPreview(getExportData(), "BỆNH ÁN GÂY MÊ HỒI SỨC (BÁC SĨ)");
